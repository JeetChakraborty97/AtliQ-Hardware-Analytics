...
Description Given:
  ...
  As a product owner, I need an aggregate forecast accuracy report for all the customers for a given fiscal year (as of now, I need FY 2021, but in future, I would require others) so that I can track the accuracy of the forecast we make for these customers.
...
-- Whereas the latest sales date is 2021-12-01
-- So the forecast table has more records than the sales table
```
...
<img width="1213" height="169" alt="SS 11" src="https://github.com/user-attachments/assets/68bad0ed-3d7b-4733-acad-2a1d0eac20f4" />

### The columns sold_quantity & forecast quantity had null values.
...
<img width="1221" height="161" alt="SS 12" src="https://github.com/user-attachments/assets/62736dc9-1856-41d0-b49f-bccd20b9dd02" />

### Let's aggregate the entire thing at the customer_code level
...
<img width="1224" height="162" alt="SS 13" src="https://github.com/user-attachments/assets/141ff03c-d3d2-4d7d-ab2e-f2665e86e42f" />
...
### Here is an excerpt of the updated result:

<img width="1219" height="166" alt="SS 14" src="https://github.com/user-attachments/assets/cac940d6-a139-4ed3-bab2-9e892a020dc3" />
